...
<body onload="setIndex()">
    <div class="lr_nb">
        ...
        <div class="swiper-container" style="margin-left:40px;margin-right:40px;">
    ...
    <footer class="footer" style="z-index:10000000000">
        <li class="footer_on" style="background-image: url(img/map-h.png);" onclick="javascript:window.location.href='126.html'">在线地图</li>
...
<script type="text/javascript">
    ...
    var all_data = [
        [116.326305, 39.957734, "草坪-主会场", 1],
        [116.34657, 39.966251, "舶宫剧场-副会场", 1],
        [116.331623, 39.965477, "纯音剧场-副会场", 1],
        [116.384228,39.949438, "原创集市", 1],
    ...
    var markernav = 0
    if (!catid) {
        center = new BMap.Point(116.347002, 39.948221);
        indexSwiper(0)
    ...
    function navChange(data, center_lng, center_lat) {
        ...
        $.each(data, function (n, val) {
            ...
            //对label 样式区分中心点与普通点
            if (val[0] == center_lng && val[1] == center_lat||val[3]==1) {
                label.setStyle({
                    color: '#fff',
    ...
    function search_data() {
        ...
        if (txt) {
            getL('.goods', 'post', ajaxUrl + '/shop_Search', { name: txt }, getData);
        } else {
