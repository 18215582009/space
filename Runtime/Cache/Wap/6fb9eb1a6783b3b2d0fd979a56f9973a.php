...
<html>
	...
	<?php if(is_array($feed_list)): $i = 0; $__LIST__ = $feed_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$feed_info): $mod = ($i % 2 );++$i;?><div class="weui_panel weui_panel_access">
		    ...
		    <a class="weui_panel_ft auditBtn" href="javascript:void(0);" 
		    	data-pass-url="<?php echo U('Index/auditPass', array('feed_id'=>$feed_info['feed_id']));?>"
		    	data-no-pass-url="<?php echo U('Index/auditNoPass', array('feed_id'=>$feed_info['feed_id']));?>">审核</a>
